	...
	if($msg==''){
		if(isset($_GET['id']) && $_GET['id']!=''){
			if($_FILES['image']['name']!=''){
				...
				imageCompress($_FILES['image']['tmp_name'],'../media/product/'.$image);
			...
			if(isset($_FILES['product_images']['name'])){
				...
				if($_FILES['product_images']['name'][$key]!=''){
					if(isset($_POST['product_images_id'][$key])){
						...
						imageCompress($_FILES['product_images']['tmp_name'][$key],'../media/product_images/'.$image);
									...
									<div class="row"  id="image_box">
									  <div class="col-lg-10">
									   <label for="categories" class=" form-control-label">Image</label>
										...
										<?php
										if($image!=''){
echo "<a target='_blank' href='".'../media/product/'.$image."'><img width='150px' src='".'../media/product/'.$image."'/></a>";
										}
										?>
									  </div>
									  <div class="col-lg-2">
